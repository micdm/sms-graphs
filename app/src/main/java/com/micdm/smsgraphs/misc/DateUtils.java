...
public class DateUtils {
    ...
    public static String formatForBundle(Calendar date) {
        return bundleFormat.format(date.getTime());
    }

    public static Calendar parseForBundle(String string) {
        try {
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(bundleFormat.parse(string));
            return calendar;
